...
window.TRATAMIENTOS_ESTETICA = [
  ...
  { "nombre": "Depilación masculina — Genitales con tiro de cola", "slug": "depilacion-masculina-genitales-tiro-de-cola", "categoria": "depilacion-masculina", "descripcion": "Depilación definitiva por láser de la zona genital junto con el tiro de cola (zona interglútea).", "beneficios": ["Reduce el vello de forma permanente con cada sesión, al destruir el folículo piloso mediante fototermólisis selectiva", "Previene la foliculitis y reduce el vello encarnado y las irritaciones típicas de otros métodos", "Mejora la textura y el tono de la piel al estimular colágeno y elastina", "Método preciso y seguro, que no daña la piel circundante"] },
  ...
  { "nombre": "Depilación masculina — Tiro de cola", "slug": "depilacion-masculina-tiro-de-cola", "categoria": "depilacion-masculina", "descripcion": "Depilación definitiva por láser del tiro de cola (zona interglútea), que reduce progresivamente el vello mediante la aplicación de tecnología láser sobre el folículo piloso.", "beneficios": ["Reduce el vello de forma permanente con cada sesión, al destruir el folículo piloso mediante fototermólisis selectiva", "Previene la foliculitis y reduce el vello encarnado y las irritaciones típicas de otros métodos", "Mejora la textura y el tono de la piel al estimular colágeno y elastina", "Método preciso y seguro, que no daña la piel circundante"] }
];
